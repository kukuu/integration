...
Python is used for ensuring data ingestion, cleansing, transformation and for batch processing using multiple Spreadsheet as data source ( other sources include live streaming from an asynchronous distributed system via an API). Example of the format of sample data is provided below:
